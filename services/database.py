...
def add_partner(db: Session, user_id: int, partner_id: str, bitrix_contact_id: str):
    db_partner = Partner(user_id=user_id, partner_id=partner_id, bitrix_contact_id=bitrix_contact_id)
    db.add(db_partner)
    db.commit()
